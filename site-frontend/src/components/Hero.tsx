...
export default function Hero() {
  ...
  const { index, progress, goTo, next, prev, isReducedMotion, interactionHandlers } =
    useCarouselAutoplay({ slideCount: heroSlides.length, durationMs: AUTOPLAY_MS });
  ...
  return (
    <section
      id="home"
      ref={rootRef}
      className="relative isolate h-[92vh] min-h-[560px] w-full overflow-hidden bg-[#201a1a] pt-24 md:pt-[124px]"
    ...
    >
      ...
      <div className="container-page relative z-10 flex h-full items-end pb-24 md:pb-28">
